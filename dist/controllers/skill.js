...
const getAll = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const all = yield index_service_1.Skill.findAll({});
...
const getById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const item = yield index_service_1.Skill.findOne({
...
const findByKeyword = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield index_service_1.Skill.findAll({
            where: {
                or: [
...
const remove = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield index_service_1.Skill.destroy({ where: { key: "id", value: id } });
...
const create = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const newItem = yield index_service_1.Skill.create({
            name,
            description,
            rate,
        });
...
const update = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params;
    try {
        const updated = yield index_service_1.Skill.findOne({
            where: { key: "id", value: id },
        });
        if (updated) {
            ...
            updated.rate = rate || (updated === null || updated === void 0 ? void 0 : updated.rate);
            yield index_service_1.Skill.update(id, updated);
            return res
                .status(200)
