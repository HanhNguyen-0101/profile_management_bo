...
const getAll = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const all = yield index_service_1.Category.findAll({});
...
const getById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const item = yield index_service_1.Category.findOne({
...
const findByKeyword = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield index_service_1.Category.findAll({
            where: {
                or: [
...
const remove = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        yield index_service_1.Category.destroy({ where: { key: "id", value: id } });
        yield index_service_1.SubCategory.destroy({ where: { key: "categoryId", value: id } });
...
const create = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const newItem = yield index_service_1.Category.create({
            name,
            description,
        });
        return res
...
const update = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params;
    try {
        const updated = yield index_service_1.Category.findOne({
            where: { key: "id", value: id },
        });
        if (updated) {
            ...
            yield index_service_1.Category.update(id, updated);
            return res
                .status(200)
